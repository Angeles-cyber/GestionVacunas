...
<body>
    <div class="login-card mx-auto">
        <i class="bi bi-person-badge-fill icon-user"></i>
        <div class="login-title">Bienvenido Administrador</div>
        <div class="login-subtitle">Inicie sesión para continuar</div>
