...
<head>
    ...
    <title>Panel Administrador - Principal</title>
    ...
    <style>
        ...
        .bg-pacientes { background: #6c757d; }
        .bg-doctores { background: #198754; }
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold" href="#">
                <i class="bi bi-person-gear"></i> Panel del Administrador
            </a>
        </div>
    </nav>
    ...
    <div class="container main-container position-relative">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="card text-center h-100">
                    <div class="card-body">
                        <div class="icon-circle bg-pacientes mb-2">
                            <i class="bi bi-person-vcard-fill"></i>
                        </div>
                        <h5 class="card-title text-secondary">Pacientes</h5>
                        <p class="card-text">Consulta y administra la lista de pacientes registrados.</p>
                        <button class="btn btn-secondary btn-custom mt-2" onclick="window.location.href='pacientes.php'">
                            <i class="bi bi-arrow-right-circle"></i> Acceder
                        </button>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="card text-center h-100">
                    <div class="card-body">
                        <div class="icon-circle bg-doctores mb-2">
                            <i class="bi bi-person-badge-fill"></i>
                        </div>
                        <h5 class="card-title text-success">Doctores</h5>
                        <p class="card-text">Consulta y gestiona la información de doctores.</p>
                        <button class="btn btn-success btn-custom mt-2" onclick="window.location.href='doctores.php'">
                            <i class="bi bi-arrow-right-circle"></i> Acceder
                        </button>
                    </div>
                </div>
